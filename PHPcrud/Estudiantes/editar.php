<?php
    ...
    if(isset($_POST['editar'])){
        ...
        $data->setDirecion($_POST['direcion']);
        $data->setLogros($_POST['logros']);
        $data->update();
        /* verificacion */
        echo"<script>alert('los datos fueron editados exitosamente');document.location='estudiantes.php'</script>";
    }
?>
<!DOCTYPE html>
<html>
